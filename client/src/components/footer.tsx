      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-display font-semibold">ImageVault</span>
            </div>
            <p className="text-gray-400 mb-6" data-testid="footer-description">
              Professional image hosting for developers who need reliable, fast, and scalable solutions.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400" data-testid="copyright">
            &copy; 2024 ImageVault. All rights reserved.
          </p>
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            <div className="flex items-center space-x-2 text-emerald-400">
              <div className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse"></div>
              <span className="text-sm" data-testid="system-status">All systems operational</span>
            </div>
          </div>
        </div>
      </div>
